...
let add2 = Number(param1);
let add3 = Number(param2);
return add2 + add3;
}
let sum = add('2', 2);
console.log(sum);
...
function nameCheck(myName) {
 ...
 let nameGreeting = nameCheck('Alissa');
...
console.log(emailCheck('email@email.com'));
...
function buyChocolate2(gold) {
  let totalFrogs = Math.floor(gold / 3); 
  return totalFrogs; 
}
totalFrogs = buyChocolate2(14); 
console.log(totalFrogs); 
...
function isTheArrayInOrder(array) {
  let num = array[0]; 
...
console.log(isTheArrayInOrder(sampleArray));
